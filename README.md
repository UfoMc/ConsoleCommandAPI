...
> The UfoMc command API is a simple way to add commands to your console.
 ...
 - you can easily add your own commands by following the tutorial down below
...
public class Stop extends CommandImp {
    public Stop() {
        super("The <stop> command will stop the service");
    }
...
> So as easy as that we got our selfs own console commands.
> cool! :D
